...
// public class TurnByV2 extends CommandBase {
...
//     public TurnByV2 (Drivetrain p_drivetrain, GyroScope p_gyro, double angle){
...
//     public float addToGyro(double turnAmount) {
