...
def main():
    ...
    NetworkTables.initialize(server='roborio-4470-frc.local')  # need to test ip
    ...
    while True:
        ...
        hsv_img = cv2.cvtColor(input_stream, cv2.COLOR_BGR2HSV)
        ...
        if len(contour_list) != 0:
            ...
            # Draw rectangle and center circle on output image
